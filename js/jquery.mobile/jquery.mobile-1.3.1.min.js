...
(function(e, t, i) {
    ...
    (function(e) {
        ...
        e.widget("mobile.loader", {options: {theme: "a", textVisible: !1, html: "", text: "Cargando"}, defaultHtml: "<div class='" + t + "'>" + "<span class='ui-icon ui-icon-loading'></span>" + "<h1></h1>" + "</div>", fakeFixLoader: function() {
